      ...
      <div class="container-fluid">
        ...
        <!-- Horizontal Form -->
            <div class="card card-info">
              ...
              <!-- /.card-header -->
                    <!-- form start -->
                     <form class="form-horizontal" method="post" action="{{url('admin/update-akun/'.$data->id)}}" enctype="multipart/form-data">
                      @csrf
                        <div class="card-body">
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <br>
                                <a data-fancybox="gallery" href="{{$data->avatar}}"><img width="100" src="{{$data->avatar}}"></a>
                            </div>
                        </div>
                        <hr>
                        </div>
